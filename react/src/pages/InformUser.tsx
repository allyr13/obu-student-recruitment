...
//       try {
//         const response = await fetch('/api/get_table_data'); // Assuming this is the correct endpoint
//         const result = await response.json();

//         // Check if the status is 200 and result contains data
//         if (result.status === 200 && result.data) {
//           // Filter out the first key-value pair, removing those with value 0
//           const filteredData: Data = {};

//           for (const [key, value] of Object.entries(result.data)) {
//             // Explicitly define the type of 'value' as {0: string | number}
//             const valueObj = value as { [key: number]: string | number };
            
//             // Extract the first value (assuming it's always in {0: value} format)
