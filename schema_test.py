...
try:
    validate(instance=json_test, schema=schema)
    print("Valid!")
except jsonschema.exceptions.ValidationError as err:
    print("Invalid!")

## Missing value (Output: Invalid!)
...
## Correct Input: Multiple entries (Output: Valid!)
...
## Insufficient Input (Output: Invalid!)
